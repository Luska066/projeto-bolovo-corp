...
export default function CoberturasFive(){
    return(
        <section className={`flex flex-col justify-center items-center py-[35px] bg-[white]`}>
            ...
            <div className="flex flex-col items-center text-center pb-[65px]">
                ...
                <h3 className={`text-[20px] w-[730px] text-[${Colors().navyBlue}]`} >Compare os planos Econômico e Completo da Zurich com os outros seguros do mercado e escolha a melhor opção para você.</h3>
            </div>
