...
export default function SectionHomeThree(){
    return(
        <section className={`flex justify-center items-center bg-[${Colors().lightBlue}] py-10 flex-col`}>
            ...
            <section  className="flex items-center flex-wrap justify-center  w-full ">
                <article className="flex flex-row gap-6 border-r me-28 pe-28 border-blue-600">
                    <div id='image'>
                        <img width={'80px'} src="https://www.zurich.com.br/pt-br/-/media/project/zwp/brazil/Images/seguro-celular/v2/economic.webp"/>
                    </div>
                    <div id="plan">
                ...
                <article className="flex flex-row gap-6 mt-6">
                    <div id='image'>
                        <img width={'60px'} src="https://www.zurich.com.br/pt-br/-/media/project/zwp/brazil/Images/seguro-celular/v2/complete.webp"/>
                    </div>
